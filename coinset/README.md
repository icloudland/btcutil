...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/icloudland/btcutil/coinset)
...
```bash
$ go get -u github.com/icloudland/btcutil/coinset
```
